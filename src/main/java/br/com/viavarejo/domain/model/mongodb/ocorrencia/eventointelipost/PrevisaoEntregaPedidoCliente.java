...
public class PrevisaoEntregaPedidoCliente implements DomainObject<PrevisaoEntregaPedidoCliente> {

	private static final long serialVersionUID = 1L;

	@ApiModelProperty(notes = "Data estimada de entrega (cliente) atual em Unix Timestamp.", required = false)
	@JsonProperty("current")
	private Date dataEstimadaUnix;

	@ApiModelProperty(notes = "Data estimada de entrega (cliente) atual em Timestamp.", required = false)
	@JsonProperty("current_iso")
	private Date dataEstimada;

	@ApiModelProperty(notes = "Data estimada de entrega (cliente) sem nenhuma regra de negócio aplicada. É enviado no formato unix timestamp.", required = false)
	...
	public String toString() {
		return "PrevisaoEntregaPedidoCliente [dataEstimadaUnix=" + this.dataEstimadaUnix + ", dataEstimada="
